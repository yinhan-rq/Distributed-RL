...
import warnings
import torch 
import distribute_rl_cartpole as drl
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lr', type=float, default=0.001, help='learning rate of the algorithm')
    parser.add_argument('--epoch', type=int, default=4, help='the epoch during training')
    parser.add_argument('--nsteps', type=int, default=1000, help='the steps to collect samples')
