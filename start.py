...
from A3C_agent import A2C_agent
...
def main(args):
    ...
    if args.mode == "normal":
        ...
        agent.train()
    #if args.mode == "A2C":
    #    agent = A2C_agent(args)
    #    agent.train()
    #    agent.test()
    #if args.mode == "ray":
    #    worker_manager = drl.get_worker_manager(args)
    #    worker_manager.start_train_ray()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_workers', type=int, default=1, help='the number of workers to collect samples')
    parser.add_argument('--env_name', type=str, default='5_vs_5', help='the environment name')
    parser.add_argument('--batch_size', type=int, default=64, help='the batch size of updating')
    parser.add_argument('--lr', type=float, default=0.0001, help='learning rate of the algorithm')
